<template>
    <view class="content">
        <view @tap="onPageTap('../user-info/userinfo')" class="header" v-bind:class="{'status':isH5Plus}"
              :style='{"backgroundColor":"#07A771","height":"200rpx"}'>
            ...
            <view class="setting" :style='{"color":"#47EDB5","fontSize":"40rpx"}'>
            ...
            <view v-for="item in menuList" v-bind:key="item.roleName">
                <view v-if="role==item.roleName" v-bind:key="index" v-for=" (menu,index) in item.backMenu">
                    <view v-bind:key="sort" v-for=" (child,sort) in menu.child">
                        <view
                                :style='{"backgroundColor":"rgba(255, 255, 255, 1)","borderColor":"#07A771","lineHeight":"80rpx","borderStyle":"solid","borderWidth":"0 0 1rpx  0"}'
                                @tap="onPageTap('../'+child.tableName+'/list?userid='+user.id)" class="li"
                                hover-class="hover">
                            <view :style='{"color":"#47EDB5","fontSize":"28rpx"}' class="text">
                                {{child.menu}}</view>
                            <view class="cuIcon-right" :style='{"color":"#47EDB5","fontSize":"28rpx"}'>
                            </view>
                        </view>
                    </view>
                </view>

        ...
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="文章标题" prop="wenzhangName">
                       <el-input v-model="ruleForm.wenzhangName"
                                 placeholder="文章标题" clearable  :readonly="ro.wenzhangName"></el-input>
                   </el-form-item>
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="文章类型" prop="wenzhangTypes">
                        <el-select v-model="ruleForm.wenzhangTypes" :disabled="ro.wenzhangTypes" placeholder="请选择文章类型">
                            <el-option
                ...
                <el-col :span="12">
                    <el-form-item class="upload" v-if="type!='info' && !ro.wenzhangFile" label="文章" prop="wenzhangFile">
                        <file-upload
                                tip="点击上传文章"
                                action="file/upload"
                                :limit="3"
                                :multiple="true"
                                :fileUrls="ruleForm.wenzhangFile?ruleForm.wenzhangFile:''"
                                @change="wenzhangFileUploadChange"
                        ></file-upload>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.wenzhangFile" label="文章" prop="wenzhangFile">
                            <a type="text" style="text-decoration:none" class="el-button" :href="ruleForm.wenzhangFile"  >文章下载</a>
                        </el-form-item>
                    </div>
                </el-col>
               <el-col :span="12">
               ...
               <el-col :span="12">
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="文章内容" prop="wenzhangContent">
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.wenzhangContent" label="文章内容" prop="wenzhangContent">
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            wenzhangFileUploadChange(fileUrls){
                this.ruleForm.wenzhangFile = fileUrls;
                this.addEditUploadStyleChange()
            },

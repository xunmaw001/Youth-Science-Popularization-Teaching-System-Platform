...
public class KechuangzuopinView extends KechuangzuopinEntity implements Serializable {
	...
	public KechuangzuopinView() {

	}

	public KechuangzuopinView(KechuangzuopinEntity kechuangzuopinEntity) {
		try {
			BeanUtils.copyProperties(this, kechuangzuopinEntity);
